...
const travelStayConfig = {
  id: "travel-stay-1",
  title: "Travel & Stay",
  description: "We have arranged comfortable accommodation for our guests. Below are the travel and stay details to make your journey smooth and memorable.",
  hotelItems: [
    {
      label: "Hotel",
      ...
      >
        ...
        <motion.div>
          ...
          <motion.ul
            ...
            variants={containerVariants}
          >
            {travelStayConfig.hotelItems.map((item, index) => (
              <motion.li
                key={item.label}
              ...
              >
                ...
                <div>
                  <strong className="text-gray-900 font-semibold text-lg block">
                    {item.label}:
                  </strong>
                  <span
        ...
        >
          ...
          >
            ...
            <img
              src={travelStayConfig.image.src}
              alt={travelStayConfig.image.alt}
