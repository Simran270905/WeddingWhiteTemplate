      ...
      >
        ...
        <motion.div>
          ...
          <div className="space-y-10 relative pl-6 lg:pl-10">
            ...
            {weddingEventsConfig.events.map((event, index) => (
              <motion.div
                key={index}
        ...
        >
          <motion.img
            src={weddingEventsConfig.image.src}
            alt={weddingEventsConfig.image.alt}
