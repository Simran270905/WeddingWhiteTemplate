    ...
    <section className="w-full py-20 bg-transparent">
      ...
      >
        ...
        <ProfileCard
          ...
          name="Kwan"
          role="Groom"
          groomBio="Kwan is a passionate photographer who captures life's beautiful moments. His calm demeanor and creative vision make him the perfect partner for this love story."
          brideBio=""
          delay={0}
        />
        ...
        <ProfileCard
          ...
          role="Bride"
          groomBio=""
          brideBio="Kiaraa is a talented graphic designer with a heart full of love and creativity. Her joyful spirit lights up every room she enters."
          delay={0.4}
        />
      </motion.div>
    </section>
...
function ProfileCard({ image, name, role, groomBio, brideBio, delay = 0 }) {
  ...
  return (
    ...
    >
      ...
      {/* TWO SEPARATE EDITABLE PARAGRAPHS */}
      {groomBio && (
        <motion.p 
